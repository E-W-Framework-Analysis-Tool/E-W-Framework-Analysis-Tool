...
public class EdFiCTEProgramProviderTests
{
    [Fact]
    ...
    {
        var testData = new List<EdFiStudentCTEProgramAssociation>
        {
    ...
    public void Should_ClearCache_When_ClearCacheCalled()
    {
        ...
        field.SetValue(provider, new List<EdFiStudentCTEProgramAssociation>());
