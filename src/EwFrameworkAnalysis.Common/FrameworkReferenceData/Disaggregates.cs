...
public static class EwFrameworkDisaggregates
{
    ...
    [
        new Disaggregate
        {
            ...
            DataElementName = "Student race/ethnicity"
        },
        new Disaggregate
        {
            Name = "Gender",
        ...
        new Disaggregate
        {
            ...
            Sectors = [Sector.PK, Sector.K12, Sector.PS, Sector.WF],
            DataElementName = "Disability status"
        },
        new Disaggregate
        {
            Name = "Income level",
        ...
        new Disaggregate
        {
            ...
            Sectors = [Sector.PK, Sector.K12, Sector.PS, Sector.WF],
            DataElementName = "Parental education level"
        },
        new Disaggregate
        {
            ...
            DataElementName = "First-generation college student"
        },
        new Disaggregate
        {
            ...
            DataElementName = "Student from migrant family household"
        },
        new Disaggregate
        {
            Name = "Home language",
        ...
        new Disaggregate
        {
            ...
            Sectors = [Sector.PK, Sector.K12, Sector.PS, Sector.WF],
            DataElementName = "English learner status"
        },
        new Disaggregate
        {
        ...
        new Disaggregate
        {
            ...
            Sectors = [Sector.K12],
            DataElementName = "K-12 school type"
        },
        new Disaggregate
        {
            ...
            Sectors = [Sector.PS],
            DataElementName = "Postsecondary institution classification"
        },
        new Disaggregate
        {
            ...
            Sectors = [Sector.PS],
            DataElementName = "Transfer enrollment status"
        },
        new Disaggregate
        {
            ...
            Sectors = [Sector.PS],
            DataElementName = "Credential-seeking status"
        },
        new Disaggregate
        {
            ...
            Sectors = [Sector.PS],
            DataElementName = "Student parenting status"
        },
        new Disaggregate
        {
            ...
            DataElementName = "Postsecondary major"
        },
        new Disaggregate
        {
            ...
            Sectors = [Sector.WF],
            DataElementName = "Occupation category"
        },
        new Disaggregate
        {
            ...
            Sectors = [Sector.PS, Sector.WF],
            DataElementName = "Dislocated worker status"
        },
        new Disaggregate
        {
            ...
            Sectors = [Sector.WF],
            DataElementName = "Basic skills level"
        },
        new Disaggregate
        {
            Name = "Age group",
        ...
        new Disaggregate
        {
            ...
            Sectors = [Sector.PK, Sector.K12, Sector.PS, Sector.WF],
            DataElementName = "Individuals experiencing homelessness"
        },
        new Disaggregate
        {
            ...
            Sectors = [Sector.PK, Sector.K12, Sector.PS, Sector.WF],
            DataElementName = "Individual or family military status"
        },
        new Disaggregate
        {
            ...
            Sectors = [Sector.PK, Sector.K12, Sector.PS],
            DataElementName = "Individual with current or past child welfare involvement"
        },
        new Disaggregate
        {
            ...
            Sectors = [Sector.K12, Sector.PS, Sector.WF],
            DataElementName = "Justice involvement"
        }
    ];
}
...
public class Disaggregate
{
    ...
    public string? DataElementName { get; init; }
}
