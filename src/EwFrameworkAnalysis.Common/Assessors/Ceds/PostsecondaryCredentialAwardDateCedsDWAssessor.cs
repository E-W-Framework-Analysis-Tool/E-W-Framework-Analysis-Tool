...
/// <summary>
/// Profiles postsecondary credential award dates from RDS.FactPsStudentAcademicAwards,
...
/// </summary>
public class PostsecondaryCredentialAwardDateCedsDWAssessor : ICedsDWAssessor
{
    public string DataElementName => "Postsecondary credential award date";
