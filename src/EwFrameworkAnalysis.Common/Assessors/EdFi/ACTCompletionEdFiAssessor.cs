...
public class ACTCompletionEdFiAssessor : IEdFiAssessor
{
    ...
    public string AssessmentDescription =>
        "Count of students with ACT assessment records";
        ...
        HttpClient httpClient, DataSource dataSource, AssessorContext context)
    {
        ...
        await EdFiApiPatterns.PageAndProcessAsync<EdFiAssessment>(
            ...
            assessment =>
            {
                ...
                if (isAct)
                {
                    ...
                    context.Log($"Found ACT assessment: {assessment.AssessmentIdentifier}");
                }
            },
            context
        );
        ...
        context.ReportProgress(50, "Counting student ACT records...");
        ...
        context.Log($"Found {totalCount:N0} student ACT assessment records");
        context.ReportProgress(100, "Complete");
