...
public class CivicEngagementSurveysPostsecondaryEdFiAssessor : IEdFiAssessor
{
    private readonly EdFiStudentAssessmentProvider _assessmentProvider;

    public CivicEngagementSurveysPostsecondaryEdFiAssessor(EdFiStudentAssessmentProvider assessmentProvider)
    {
        _assessmentProvider = assessmentProvider;
    }

    public string DataElementName => "Civic engagement surveys (Postsecondary)";

    public string AssessmentDescription =>
        "Analyzes studentAssessments as a baseline proxy for postsecondary civic engagement surveys. " +
        "Ed-Fi has no standard descriptor for civic engagement survey categories.";
