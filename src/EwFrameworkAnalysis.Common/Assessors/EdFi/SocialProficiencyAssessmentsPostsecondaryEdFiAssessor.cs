...
public class SocialProficiencyAssessmentsPostsecondaryEdFiAssessor : IEdFiAssessor
{
    ...
    public SocialProficiencyAssessmentsPostsecondaryEdFiAssessor(EdFiStudentAssessmentProvider assessmentProvider)
    {
    ...
    public string AssessmentDescription =>
        "Analyzes studentAssessments as a baseline proxy for postsecondary social proficiency performance assessments. " +
