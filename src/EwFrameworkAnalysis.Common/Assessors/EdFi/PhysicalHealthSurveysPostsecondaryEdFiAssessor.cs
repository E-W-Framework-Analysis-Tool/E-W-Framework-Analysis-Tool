...
public class PhysicalHealthSurveysPostsecondaryEdFiAssessor : IEdFiAssessor
{
    ...
    public PhysicalHealthSurveysPostsecondaryEdFiAssessor(EdFiStudentAssessmentProvider assessmentProvider)
    {
    ...
    public string AssessmentDescription =>
        "Analyzes studentAssessments as a baseline proxy for postsecondary physical health surveys. " +
