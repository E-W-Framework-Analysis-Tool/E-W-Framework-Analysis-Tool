...
public class CulturalCompetencyAssessmentsPostsecondaryEdFiAssessor : IEdFiAssessor
{
    private readonly EdFiStudentAssessmentProvider _assessmentProvider;

    public CulturalCompetencyAssessmentsPostsecondaryEdFiAssessor(EdFiStudentAssessmentProvider assessmentProvider)
    {
        _assessmentProvider = assessmentProvider;
    }

    public string DataElementName => "Cultural competency assessments (Postsecondary)";

    public string AssessmentDescription =>
        "Analyzes studentAssessments as a baseline proxy for postsecondary cultural competency assessments. " +
        "Ed-Fi has no standard descriptor for cultural competency assessment categories.";
