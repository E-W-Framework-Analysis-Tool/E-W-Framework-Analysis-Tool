...
public class HealthRelatedQualityOfLifeEdFiAssessor : IEdFiAssessor
{
    ...
    public HealthRelatedQualityOfLifeEdFiAssessor(EdFiStudentAssessmentProvider assessmentProvider)
    {
    ...
    public string AssessmentDescription =>
        "Analyzes studentAssessments as a baseline proxy for Health-Related Quality of Life Scale scores. " +
        "Ed-Fi has no standard descriptor for HRQoL assessment categories.";
