...
public class SocialAwarenessTeacherRatingsEdFiAssessor : IEdFiAssessor
{
    ...
    public SocialAwarenessTeacherRatingsEdFiAssessor(EdFiStudentAssessmentProvider assessmentProvider)
    {
    ...
    public string AssessmentDescription =>
        "Analyzes studentAssessments as a baseline proxy for teacher ratings of social awareness and social skills. " +
        "Ed-Fi has no standard descriptor for social awareness teacher rating categories.";
