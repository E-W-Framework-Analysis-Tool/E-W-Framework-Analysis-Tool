...
public class DevelopmentalScreeningResultsEdFiAssessor : IEdFiAssessor
{
    ...
    public DevelopmentalScreeningResultsEdFiAssessor(EdFiStudentAssessmentProvider assessmentProvider)
    {
    ...
    public string AssessmentDescription =>
        "Analyzes studentAssessments as a baseline proxy for developmental screening results. " +
        "Ed-Fi has no standard descriptor for developmental screening categories.";
