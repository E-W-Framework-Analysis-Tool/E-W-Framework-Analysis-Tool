...
public class StateAssessmentsPreKLanguageAndLiteracy : IEdFiAssessor
{
    ...
    public string AssessmentDescription => "Count of Pre-K students with early learning results in language and literacy";
    ...
    {
        context.ReportProgress(0, "Counting total PreK students...");
