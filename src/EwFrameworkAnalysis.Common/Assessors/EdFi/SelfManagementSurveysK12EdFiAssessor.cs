...
public class SelfManagementSurveysK12EdFiAssessor : IEdFiAssessor
{
    ...
    public SelfManagementSurveysK12EdFiAssessor(EdFiStudentAssessmentProvider assessmentProvider)
    {
    ...
    public string AssessmentDescription =>
        "Analyzes studentAssessments as a baseline proxy for self-management surveys. " +
