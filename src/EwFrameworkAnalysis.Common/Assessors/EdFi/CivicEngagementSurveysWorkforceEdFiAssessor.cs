...
public class CivicEngagementSurveysWorkforceEdFiAssessor : IEdFiAssessor
{
    private readonly EdFiStudentAssessmentProvider _assessmentProvider;

    public CivicEngagementSurveysWorkforceEdFiAssessor(EdFiStudentAssessmentProvider assessmentProvider)
    {
        _assessmentProvider = assessmentProvider;
    }

    public string DataElementName => "Civic engagement surveys (Workforce)";

    public string AssessmentDescription =>
        "Analyzes studentAssessments as a baseline proxy for workforce civic engagement surveys. " +
