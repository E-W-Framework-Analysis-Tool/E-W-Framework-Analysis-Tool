...
public class GrowthMindsetSurveysPostsecondaryEdFiAssessor : IEdFiAssessor
{
    ...
    public GrowthMindsetSurveysPostsecondaryEdFiAssessor(EdFiStudentAssessmentProvider assessmentProvider)
    {
    ...
    public string AssessmentDescription =>
        "Analyzes studentAssessments as a baseline proxy for postsecondary growth mindset surveys. " +
