...
public class SelfEfficacySurveysPostsecondaryEdFiAssessor : IEdFiAssessor
{
    ...
    public SelfEfficacySurveysPostsecondaryEdFiAssessor(EdFiStudentAssessmentProvider assessmentProvider)
    {
    ...
    public string AssessmentDescription =>
        "Analyzes studentAssessments as a baseline proxy for postsecondary self-efficacy surveys. " +
