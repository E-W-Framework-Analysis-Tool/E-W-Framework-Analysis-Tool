...
public class CommunicationSkillsAssessmentsEdFiAssessor : IEdFiAssessor
{
    ...
    public CommunicationSkillsAssessmentsEdFiAssessor(EdFiStudentAssessmentProvider assessmentProvider)
    {
    ...
    public string AssessmentDescription =>
        "Analyzes studentAssessments as a baseline proxy for communication skills assessments. " +
