...
public class MentalEmotionalWellBeingAssessmentsEdFiAssessor : IEdFiAssessor
{
    ...
    public MentalEmotionalWellBeingAssessmentsEdFiAssessor(EdFiStudentAssessmentProvider assessmentProvider)
    {
    ...
    public string AssessmentDescription =>
        "Analyzes studentAssessments as a baseline proxy for mental and emotional well-being assessments. " +
        "Ed-Fi has no standard descriptor for mental health assessment categories.";
