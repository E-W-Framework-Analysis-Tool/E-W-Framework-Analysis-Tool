...
public class SATScoreEdFiAssessor : IEdFiAssessor
{
    ...
    public string AssessmentDescription =>
        "Count of students with SAT score results";
        ...
        HttpClient httpClient, DataSource dataSource, AssessorContext context)
    {
        ...
        context.ReportProgress(50, "Counting student SAT score records...");
        ...
        context.Log($"Found {totalCount:N0} student SAT score records");
        context.ReportProgress(100, "Complete");
