...
public class TeacherReportsSocialEmotionalEdFiAssessor : IEdFiAssessor
{
    ...
    public TeacherReportsSocialEmotionalEdFiAssessor(EdFiStudentAssessmentProvider assessmentProvider)
    {
    ...
    public string AssessmentDescription =>
        "Analyzes studentAssessments as a baseline proxy for teacher reports of social-emotional development. " +
        "Ed-Fi has no standard descriptor for social-emotional teacher report categories.";
