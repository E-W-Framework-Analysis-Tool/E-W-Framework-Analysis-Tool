...
public class DirectChildAssessmentsPhysicalDevelopmentEdFiAssessor : IEdFiAssessor
{
    ...
    public DirectChildAssessmentsPhysicalDevelopmentEdFiAssessor(EdFiStudentAssessmentProvider assessmentProvider)
    {
    ...
    public string AssessmentDescription =>
        "Analyzes studentAssessments as a baseline proxy for direct child assessments of physical development. " +
        "Ed-Fi has no standard descriptor for physical development assessment categories.";
