...
public class DirectChildAssessmentsExecutiveFunctionEdFiAssessor : IEdFiAssessor
{
    ...
    public DirectChildAssessmentsExecutiveFunctionEdFiAssessor(EdFiStudentAssessmentProvider assessmentProvider)
    {
    ...
    public string AssessmentDescription =>
        "Analyzes studentAssessments as a baseline proxy for direct child assessments of executive function. " +
        "Ed-Fi has no standard descriptor for executive function assessment categories.";
