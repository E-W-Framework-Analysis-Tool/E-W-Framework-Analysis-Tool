...
public class SocialCapitalSurveysK12EdFiAssessor : IEdFiAssessor
{
    ...
    public SocialCapitalSurveysK12EdFiAssessor(EdFiStudentAssessmentProvider assessmentProvider)
    {
    ...
    public string AssessmentDescription =>
        "Analyzes studentAssessments as a baseline proxy for social capital surveys. " +
