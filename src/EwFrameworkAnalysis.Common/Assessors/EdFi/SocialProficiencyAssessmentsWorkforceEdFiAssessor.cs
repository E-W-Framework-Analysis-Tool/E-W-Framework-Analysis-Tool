...
public class SocialProficiencyAssessmentsWorkforceEdFiAssessor : IEdFiAssessor
{
    private readonly EdFiStudentAssessmentProvider _assessmentProvider;

    public SocialProficiencyAssessmentsWorkforceEdFiAssessor(EdFiStudentAssessmentProvider assessmentProvider)
    {
        _assessmentProvider = assessmentProvider;
    }

    public string DataElementName => "Social proficiency performance assessments (Workforce)";

    public string AssessmentDescription =>
        "Analyzes studentAssessments as a baseline proxy for workforce social proficiency performance assessments. " +
        "Ed-Fi has no standard descriptor for social proficiency assessment categories.";
