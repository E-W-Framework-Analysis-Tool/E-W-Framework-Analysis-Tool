...
public class PhysicalHealthSurveysK12EdFiAssessor : IEdFiAssessor
{
    ...
    public PhysicalHealthSurveysK12EdFiAssessor(EdFiStudentAssessmentProvider assessmentProvider)
    {
    ...
    public string AssessmentDescription =>
        "Analyzes studentAssessments as a baseline proxy for K-12 physical health surveys. " +
