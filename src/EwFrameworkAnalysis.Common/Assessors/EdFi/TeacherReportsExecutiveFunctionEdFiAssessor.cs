...
public class TeacherReportsExecutiveFunctionEdFiAssessor : IEdFiAssessor
{
    ...
    public TeacherReportsExecutiveFunctionEdFiAssessor(EdFiStudentAssessmentProvider assessmentProvider)
    {
    ...
    public string AssessmentDescription =>
        "Analyzes studentAssessments as a baseline proxy for teacher reports of children's executive function. " +
        "Ed-Fi has no standard descriptor for executive function teacher report categories.";
