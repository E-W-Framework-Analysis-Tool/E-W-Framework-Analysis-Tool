...
public class ReportedKindergartenReadinessPhysicalEdFiAssessor : IEdFiAssessor
{
    ...
    public ReportedKindergartenReadinessPhysicalEdFiAssessor(EdFiStudentAssessmentProvider assessmentProvider)
    {
    ...
    public string AssessmentDescription =>
        ...
        "(physical development). Ed-Fi has no standard descriptor for kindergarten readiness assessment categories.";
