...
public class CivicEngagementSurveysK12EdFiAssessor : IEdFiAssessor
{
    ...
    public CivicEngagementSurveysK12EdFiAssessor(EdFiStudentAssessmentProvider assessmentProvider)
    {
    ...
    public string AssessmentDescription =>
        "Analyzes studentAssessments as a baseline proxy for civic engagement surveys. " +
