...
public class GrowthMindsetSurveysK12EdFiAssessor : IEdFiAssessor
{
    ...
    public GrowthMindsetSurveysK12EdFiAssessor(EdFiStudentAssessmentProvider assessmentProvider)
    {
    ...
    public string AssessmentDescription =>
        "Analyzes studentAssessments as a baseline proxy for growth mindset surveys. " +
