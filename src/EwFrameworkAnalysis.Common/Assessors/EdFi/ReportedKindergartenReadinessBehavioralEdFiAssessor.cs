...
public class ReportedKindergartenReadinessBehavioralEdFiAssessor : IEdFiAssessor
{
    ...
    public ReportedKindergartenReadinessBehavioralEdFiAssessor(EdFiStudentAssessmentProvider assessmentProvider)
    {
    ...
    public string AssessmentDescription =>
        ...
        "(self-regulation, approaches to learning, executive function). " +
        "Ed-Fi has no standard descriptor for kindergarten readiness assessment categories.";
