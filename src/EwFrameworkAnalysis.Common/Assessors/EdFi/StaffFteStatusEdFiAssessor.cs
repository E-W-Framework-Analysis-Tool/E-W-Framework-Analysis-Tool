...
public class StaffFteStatusEdFiAssessor : IEdFiAssessor
{
    public string DataElementName => "Staff FTE status";

    public string AssessmentDescription =>
        "Distribution of staff by full-time equivalency from staffEducationOrganizationEmploymentAssociations";
        ...
        HttpClient httpClient, DataSource dataSource, AssessorContext context)
    {
        ...
        await EdFiApiPatterns.PageAndProcessAsync<EdFiStaffEducationOrganizationEmploymentAssociation>(
            httpClient,
        ...
        context.Log($"Found {reportedCount:N0} staff with FTE reported out of {totalRecords:N0}");
