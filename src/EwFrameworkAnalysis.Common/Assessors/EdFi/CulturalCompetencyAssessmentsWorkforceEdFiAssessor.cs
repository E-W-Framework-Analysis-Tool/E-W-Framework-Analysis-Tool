...
public class CulturalCompetencyAssessmentsWorkforceEdFiAssessor : IEdFiAssessor
{
    private readonly EdFiStudentAssessmentProvider _assessmentProvider;

    public CulturalCompetencyAssessmentsWorkforceEdFiAssessor(EdFiStudentAssessmentProvider assessmentProvider)
    {
        _assessmentProvider = assessmentProvider;
    }

    public string DataElementName => "Cultural competency assessments (Workforce)";

    public string AssessmentDescription =>
        "Analyzes studentAssessments as a baseline proxy for workforce cultural competency assessments. " +
