...
public class CampusClimateSurveysK12EdFiAssessor : IEdFiAssessor
{
    ...
    public string AssessmentDescription =>
        "Identifies surveys linked to K-12 campus/school climate instruments (e.g., Comprehensive " +
        "School Climate Inventory (CSCI), ED School Climate Surveys (ED-SCLS)) by matching " +
        "well-known instrument names and school climate keywords in the Ed-Fi surveys catalog.";
    ...
    {
        context.ReportProgress(0, "Searching survey catalog for K-12 campus climate surveys...");
        ...
        context.Log($"Found {matchingSurveys.Count} K-12 campus climate survey(s) in catalog");

        if (matchingSurveys.Count == 0)
        {
            context.ReportProgress(100, "Complete — no K-12 campus climate surveys found");
        ...
        context.Log($"Found {totalResponses:N0} campus climate survey responses");
