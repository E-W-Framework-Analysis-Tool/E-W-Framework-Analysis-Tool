...
public class SocialCapitalSurveysPostsecondaryEdFiAssessor : IEdFiAssessor
{
    ...
    public SocialCapitalSurveysPostsecondaryEdFiAssessor(EdFiStudentAssessmentProvider assessmentProvider)
    {
    ...
    public string AssessmentDescription =>
        "Analyzes studentAssessments as a baseline proxy for postsecondary social capital surveys. " +
