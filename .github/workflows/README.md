...
If you do not already have service principals created that can be used to deploy to the target Azure environment, you
will need to configure them. The Terraform code associated with the environment setup creates this and provides these
secrets as an output. Use the following commands if you have not run that or if the SPs do not otherwise exist already.
